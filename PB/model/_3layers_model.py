...
class Network(nn.Module):
    def __init__(self, input_channel=1, layers=[5, 5, 5, 1], num_regression=1):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
        ...
        self.fc = nn.Linear(256*75, num_regression)
    ...
    def forward(self, x0):
        ...
        # x = nn.utils.rnn.pack_padded_sequence(x0, seq_lens, batch_first=True)
        ...
        out1 = out.contiguous().view(-1,256*75)
        # out1 = torch.flatten(out,1)
        out2 = self.fc(out1)
        # out3 = torch.squeeze(out2,0)
        # out2 = self.Relu(out1)
        # out3 = torch.squeeze(out1, 0)
        # out3 = self.relu(out2)
